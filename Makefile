...
#Enables/disables PS5 DualSense support in the pad emulator (USB and Bluetooth).
#DS5_ENABLE is passed to pademu and ds34usb/iop builds when this is 1.
DUALSENSE ?= 1
